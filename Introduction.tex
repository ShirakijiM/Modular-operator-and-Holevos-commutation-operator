...
$$
The two norms $\parallel \cdot\parallel$ and $\parallel \cdot \parallel_2$ induced from the inner products $\langle \cdot,\cdot \rangle$ and 
...
&\leq \frac{1}{2}(\parallel \rho^{1/2}A\parallel^2+\parallel A\rho^{1/2}\parallel^2)\\
